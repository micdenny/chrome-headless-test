...
timestampElement.innerHTML = Date.now();
...
// Navigator WebDriver
const navigatorWebDriverElement = document.getElementById('navigator-webdriver');
if (navigator.webdriver) {
  navigatorWebDriverElement.innerHTML = 'present';
  navigatorWebDriverElement.classList.add('failed');
} else {
  navigatorWebDriverElement.innerHTML = 'missing';
}